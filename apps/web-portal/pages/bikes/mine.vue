  ...
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    ...
    >
      ...
      <p class="text-slate-400 mb-6">
        Please ensure you are logged in to view your collection.
      </p>
      <button
        @click="() => refresh()"
    ...
    >
      ...
      <NuxtLink
        to="/bikes/register"
        class="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all shadow-xl shadow-blue-900/20"
      >
    ...
    >
      ...
      >
        ...
        <div class="aspect-[4/3] overflow-hidden bg-slate-800 relative">
          ...
          <div
            v-else
            class="w-full h-full flex items-center justify-center text-slate-600 bg-slate-900/50"
          >
            <svg
              class="w-16 h-16"
              fill="none"
        ...
        <div class="p-5">
          <div class="flex justify-between items-start mb-1">
            ...
            >
            <span
              class="text-[10px] font-mono text-slate-600 uppercase tracking-tighter"
              >ID: {{ bike.id.split("-")[0] }}</span
            >
          </div>
          <h3
            class="text-xl font-bold text-white mb-4 group-hover:text-blue-400 transition-colors truncate"
          >
            {{ bike.make_model }}
          </h3>
          ...
          >
            ...
            <div
              class="p-2 bg-slate-800 rounded-lg group-hover:bg-blue-600 text-slate-400 group-hover:text-white transition-all"
            >
              <svg
                class="w-5 h-5"
                fill="none"
...
useHead({
  ...
  meta: [
    {
      name: "description",
      content: "Manage your bicycle property and ownership history.",
    },
  ],
});
</script>
